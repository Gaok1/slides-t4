...
Abra **index.html** em um navegador. Esta é a versão atual da apresentação, com 49 slides, tema branco minimalista, notas e demonstrações locais. Somente os links de referência precisam de internet.
...
- **Raiz de Merkle (30) e desempate (31):** dois diagramas em SVG, sem clique. O primeiro sobe a árvore de quatro transações até a raiz de 32 bytes que entra no cabeçalho; o segundo mostra a cadeia se dividindo em dois blocos 101 e o ramo com mais trabalho vencendo. O desempate é explicado só para proof of work.
...
- **Sorteio por stake (34):** distribua o stake entre quatro validadores e sorteie uma rodada ou duzentas. A proporção de turnos se aproxima da proporção de stake no agregado, sem garantia em nenhuma rodada isolada. Modelo didático: não reproduz sorteio verificável, comitês, slots, épocas nem slashing.
- **Proof of History (35–36):** a tabela compara ordens de grandeza de Bitcoin, Ethereum L1 e Solana. Na simulação, hashes continuam sem depender das transações; a cada oito ticks, uma entry incorpora em lote tudo que entrou na fila. PoH ordena os eventos, e a Solana combina esse relógio com consenso por Proof of Stake.
