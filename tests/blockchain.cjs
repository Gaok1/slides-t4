...
(async () => {
  ...
  await page.locator('#pow-difficulty').selectOption('4'); await page.locator('#pow-nonce').fill('0');
  ...
  assert.match(await page.locator('#pow-status').innerText(), /limite de 500\.000 tentativas/);
  await page.locator('#pow-nonce').fill('0'); await page.locator('#pow-difficulty').selectOption('4');
  ...
  assert.match(await page.locator('#stake-result').innerText(), /Ana propõe o bloco/);
  ...
  await page.locator('#stake-draw').click(); assert.match(await page.locator('#stake-result').innerText(), /Sem stake/);
  await page.locator('#stake-run').click(); assert.match(await page.locator('#stake-result').innerText(), /Sem stake/);
  ...
  console.log('SHA-256, UTF-8, avalanche, chain tampering, timed mining limits/cancel, stake lottery, contract guards, animation controls and offline checks passed.');
  await browser.close();
