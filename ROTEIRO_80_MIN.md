...
O deck tem 45 slides. A divisão abaixo reserva 78 minutos de fala e 2 minutos de margem para troca de apresentador, pequenos atrasos ou uma intervenção da plateia.
...
| Pessoa 3 | 23–39 | blockchain, demonstrações, redes e governança | 24 min |
| Pessoa 2 | 40–45 | horizonte, plano de migração, questões e fechamento | 12 min |
| Todos | transições | margem operacional | 2 min |
|  |  | **Total** | **80 min** |
...
- Slides 40–42 (6 min): Falcon, prazos e projeto de migração.
- Slide 43 (5 min): três questões oficiais do ENADE.
- Slides 44–45 (1 min): conclusão e referências.
...
- Slides 25‑28 (8 min): os três laboratórios e o esqueleto dos campos de um bloco Bitcoin.
- Slides 29‑31 (4 min): ciclo da transação, sorteio por stake e relógio de hashes do Proof of History.
- Slides 32‑33 (2 min): comparação BTC/ETH/SOL e contrato em custódia.
- Slides 34‑39 (6 min): risco de Shor nas três redes, exposição de chave, custo de dados, BIP 360, BIP 361 e Ethereum.
...
- Chegar ao slide 40 com aproximadamente 66 minutos.
- Iniciar as questões no minuto 72.
- Encerrar o slide 44 no minuto 78; usar os 2 minutos finais como margem.
